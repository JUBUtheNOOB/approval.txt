...
def crack_public_pilihan():
	...
	nanya_proxy = input(garis+" ketik t lalu enter ("+H+"y"+P+"/"+M+"t"+P+")  :"+H+" ")
	...
	uar = input(f"{garis} ketik t lalu enter ({H}y{P}/{M}t{P})  : {H}")
	...
	nanya_apk = input(garis+" ketik y lalu enter ("+H+"y"+P+"/"+M+"t"+P+")  :"+H+" ")
	...
	pw_tambahai = input(garis+" ketik t lalu enter ("+H+"y"+P+"/"+M+"t"+P+")  :"+H+" ")
	...
	pilpas = input(garis+" ketik t lalu enter ("+H+"y"+P+"/"+M+"t"+P+")  :"+H+" ")
